...
const index_2 = __importDefault(require("@services/domain/Pipline/index"));
...
exports.default = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const findPipeline = yield index_2.default.findOne({
        where: {
            siteId,
            type: interfaces_1.ETypePipeline.DOWNLOAD,
        },
    });
    if (findPipeline.status !== interfaces_1.EStatus.ERROR) {
        throw new Error('The pipeline cannot be started');
    }
    yield index_2.default.reloadStatus(findPipeline);
    yield index_1.default.removeSiteFolder(siteId);
    yield index_1.default.processDownloadStage(findSite.id, findSite.url);
